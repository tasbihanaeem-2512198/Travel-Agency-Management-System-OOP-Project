...
public class Forgetpassword extends JFrame implements ActionListener{
    ...
    Forgetpassword(){
        ...
        ImageIcon il=new ImageIcon(ClassLoader.getSystemResource("icons/forgotpassword.png"));
      ...
      //  tfusername.setBorder(BorderFactory.createEmptyBorder());
        ...
        search.setBackground(new Color(47,160,132));
      ...
      //  tfname.setBorder(BorderFactory.createEmptyBorder());
       tfname.setBorder(new LineBorder(Color.BLACK));
        ...
        retrieve.setBackground(new Color(47,160,132));
