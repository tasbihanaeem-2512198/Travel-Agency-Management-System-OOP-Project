...
ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/image11.jpeg"));
Image i2 = i1.getImage().getScaledInstance(600, 500, Image.SCALE_DEFAULT);
ImageIcon i3 = new ImageIcon(i2);
JLabel image = new JLabel(i3);
image.setBounds(500, 0, 600, 500);
add(image);
    ...
    if(ae.getSource()==checkprice){
     ...
     c.s.executeUpdate("INSERT INTO bookpackage VALUES ('" 
